...
const WhatsAppButton = () => {
  ...
  const phoneNumber = "212708224514"; // Format: countryCode + number
  const message = encodeURIComponent("Bonjour, je vous contacte depuis votre site web."); // Pre-filled message
